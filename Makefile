...
SERVER_SOURCES = server.c server_marshalling.c server_logging.c request_constructor.c database.c sqlite3.c
...
clientdebug: $(CLIENT_DEBUG) $(COMMON_SOURCES)
	$(CC) $(CFLAGS) $(COMMON_SOURCES) $(CLIENT_DEBUG) -o $(CLIENT_BINARY)
